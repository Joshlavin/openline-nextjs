export default function Footer() {
  return (
    <footer className="py-16 lg:py-20 px-6 border-t border-border">
      <div className="max-w-[var(--max)] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-12 mb-12">
          {/* Brand */}
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <div className="w-[28px] h-[28px] bg-accent rounded-lg flex items-center justify-center">
            ...
            <p className="text-sm text-text-3 leading-relaxed max-w-[280px]">
          ...
          {/* Product */}
          <div>
            <h4 className="text-xs font-semibold text-text-3 uppercase tracking-wider mb-5">Product</h4>
          ...
          {/* Company */}
          <div>
            <h4 className="text-xs font-semibold text-text-3 uppercase tracking-wider mb-5">Company</h4>
            <div className="flex flex-col gap-3">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-xs font-semibold text-text-3 uppercase tracking-wider mb-5">Legal</h4>
            <div className="flex flex-col gap-3">
